...
Route::get('moorden', function (){
    return "Hello Moorden Creative";
});

Route::redirect('/youtube', '/moorden');

Route::fallback(function (){
   return "404 by Moorden Creative";
});

Route::view('/hello', 'hello', ['name' => 'Jabal']);

Route::get('/hello-again', function (){
    return view('hello', ['name' => 'Jabal']);
});

Route::get('/hello-world', function (){
    return view('hello.world', ['name' => 'Jabal']);
});
...
Route::get('/conflict/jabal', function (){
    return "Conflict Jabal Abdul Salam";
});
...
//    return route('redirect-hello', ['name' => 'Jabal']);
//    return url()->route('redirect-hello', ['name' => 'Jabal']);
    return \Illuminate\Support\Facades\URL::route('redirect-hello', ['name' => 'Jabal']);
});

Route::get('/redirect/action',[\App\Http\Controllers\RedirectController::class, 'redirectAction']);
Route::get('/redirect/away',[\App\Http\Controllers\RedirectController::class, 'redirectAway']);

Route::middleware(['contoh:MCS,401'])->prefix('/middleware')->group(function (){
